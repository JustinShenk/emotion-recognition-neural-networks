...
FILE_PATHS = ['fer2013.csv', 'test.csv', 'testprivate.csv']

for file_path in FILE_PATHS:
    print("INFO: Converting {} to numpy format.".format(file_path))
    ...
    if file_path == 'fer2013.csv':
        suffix = 'train'
    elif file_path == 'test.csv':
        suffix = 'val'
    elif file_path == 'testprivate.csv':
        suffix = 'test'
    np.save('data_{}.npy'.format(suffix), images)
    np.save('labels_{}.npy'.format(suffix), labels)
